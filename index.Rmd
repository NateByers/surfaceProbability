...
An extreme value distribution was fit for each census tract centroid in the continental United States. Specifically, a joint probability density function for the $r$ largest yearly values was estimated:
...
For 8-hour maximum ozone, the top 4 values per year were used to characterize the extreme values for each census tract ($r = 4$), and for 24-hour mean PM<sub>2.5</sub> the top 7 values were used ($r = 7$).
